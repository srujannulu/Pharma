...
public class addBatchPage {
	...
	public void addBatchTest5() throws Exception{
		...
		String eAlert="Price must be a number"; //Weight must be a positive number
		Alert alert=driver.switchTo().alert();
		String arrivedAlert=alert.getText();
		alert.dismiss();
		Assert.assertEquals(arrivedAlert,eAlert);
	...
	public void takeScreenShotOnFailure(ITestResult testResult) throws IOException {
		if (testResult.getStatus() == ITestResult.FAILURE) {
			...
			FileUtils.copyFile(scrFile, new File("C:\\Users\\776492\\Documents\\FailedTestCases\\LoginPage\\" + testResult.getName() + "-" 
