...
public class pageObject {
	...
	public static final By refrigerationYes = By.xpath("(//*[@name='refrigeration'])[1]");
	public static final By refrigerationNo = By.xpath("(//*[@name='refrigeration'])[2]");
	...
	public static final By addPresentMsg = By.xpath("//span[contains(.,'The batch code already added.')]");
	...
	public static final By logout = By.xpath("(//*[@href='logout?log=out'])");
	public static final By searchBatch = By.xpath("(//*[@href='search'])");
	public static final By searchBtn = By.xpath("(//*[@onclick='return validateBatch()'])"); 
	public static final By bCodeMsg = By.xpath("//span[contains(.,'The batch code not present in system')]");
	public static final By updateBtn = By.xpath("//*[@onclick='return validateBatch()']");
}
