...
public class searchPage {
    ...
    public void SearchPageTest1() throws Exception {
        ...
        Integer xlmedicine = (int) sh1.getRow(0).getCell(1).getNumericCellValue();
        ...
        Integer xlWeight = (int) sh1.getRow(0).getCell(2).getNumericCellValue(); 
  		...
  		Integer xlprice = (int) sh1.getRow(0).getCell(3).getNumericCellValue();
  		...
  		String xlmedicinetype = sh1.getRow(0).getCell(4).getStringCellValue();
      ...
      public void SearchPageTest3() throws Exception {
    	  ...
    	  XSSFWorkbook wb=new XSSFWorkbook(fis);
    	  XSSFSheet sh1=wb.getSheetAt(1);
    	  String bc = sh1.getRow(2).getCell(0).getStringCellValue();
      ...
      @Test(priority=3)
      public void SearchPageTest4() throws Exception {
    	  File src=new File("C:\\Users\\776492\\Documents\\Testing\\Selenium\\Codes\\Test_Automation_Inheritance\\ExcelFiles\\Pharmacy.xlsx");
    	  FileInputStream fis=new FileInputStream(src);
    	  XSSFWorkbook wb=new XSSFWorkbook(fis);
    	  XSSFSheet sh1=wb.getSheetAt(1);
