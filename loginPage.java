...
public class loginPage {
	...
	public void loginPageTest2(){
		...
		String invaliduname = driver.findElement(pageObject.iuname).getText();
	...
	public void loginPageTest3(){
		...
		String einvalidpwd = "UserName and Password does not match";
		String invalidpwd = driver.findElement(pageObject.ipwd).getText();
		Assert.assertEquals(invalidpwd,einvalidpwd);
	}
